...
<body>
	...
	<section class="header">
		<div class="container">
			...
			<p><b>Meaning:</b><?php echo $result['Meaning']; ?></p>
			<p><b>Example:</b><?php echo $result['Example']; ?></p>
			<p><b>Origin:</b><?php echo $result['Origin']; ?></p>
			<p><b>Synonyms:</b><?php echo $result['Synonyms']; ?></p>
			<?php
				}
			}
			?>
